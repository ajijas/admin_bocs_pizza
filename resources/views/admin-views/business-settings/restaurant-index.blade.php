            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            @php($dine_in=\App\CentralLogics\Helpers::get_business_settings('dine_in'))
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                <div>
                                    <label class="text-dark mb-0">{{translate('dine_in')}}
                                        <i class="tio-info-outined"
                                           data-toggle="tooltip"
                                           data-placement="top"
                                           title="{{ translate('When this option is enabled, customers can book tables and place dine-in orders through the mobile app.') }}">
                                        </i>
                                    </label>
                                </div>
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="dine_in" {{$dine_in == null || $dine_in == 0? '' : 'checked'}} id="dine_in_btn">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            function validateCheckboxes() {
                if (!$('#self_pickup_btn').prop('checked') && !$('#delivery_btn').prop('checked') && !$('#dine_in_btn').prop('checked')) {
                    if (event.target.id === 'self_pickup_btn') {
                        $('#delivery_btn').prop('checked', true);
                    } else if (event.target.id === 'delivery_btn') {
            ...
            $('#dine_in_btn').change(validateCheckboxes);
        });
