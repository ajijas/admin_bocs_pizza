    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{ translate('Provide your database information.') }}
                <a href="https://docs.6amtech.com/docs-efood/admin-panel/install-on-server" target="_blank">
                ...
                <div class="bg-light p-4 rounded mb-4">
                    <div class="px-xl-2 pb-sm-3">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="database-password" class="d-flex align-items-center gap-2 mb-2">{{ translate('Database Password') }} <span class="text-muted">({{ translate('Optional') }})</span></label>
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" id="database-password"
                                               ...
                                               placeholder="Ex: password (leave empty if no password)">
