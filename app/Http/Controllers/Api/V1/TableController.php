...
class TableController extends Controller
{
        ...
        $tables = $this->table
            ...
            ->map(function ($table) {
                return [
                    ...
                    'is_available' => $table->order->isEmpty(),
                ];
            });
    ...
    public function placeOrder(Request $request): JsonResponse
    {
        ...
        try {
            ...
            try {
                Helpers::send_push_notif_to_topic(data: $KitchenNotificationData, topic: "kitchen-{$order->branch_id}", type: 'general', isNotificationPayloadRemove: true);
